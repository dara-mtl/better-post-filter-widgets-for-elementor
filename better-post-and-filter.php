...
final class BPF_Elementor {
    ...
    public function init() {
        ...
        require_once plugin_dir_path( __FILE__ ) . 'inc/classes/ajax-class.php';
        require_once plugin_dir_path( __FILE__ ) . 'inc/classes/dynamic-group-class.php';
        require_once plugin_dir_path( __FILE__ ) . 'bpf-dynamic-tag.php';
    }
