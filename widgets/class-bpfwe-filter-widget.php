...
class BPFWE_Filter_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'        => \Elementor\Controls_Manager::TEXT,
				'render_type' => 'ui',
				'description' => esc_html__( 'This shortcode will display a list of selected terms. The ID is generated by Elementor and only changes if this widget is duplicated, copied, or re-inserted from a template.', 'better-post-filter-widgets-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => \Elementor\Controls_Manager::TEXT,
				'render_type' => 'ui',
				'description' => esc_html__( 'This shortcode will display the selected terms total. The ID is generated by Elementor and only changes if this widget is duplicated, copied, or re-inserted from a template.', 'better-post-filter-widgets-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => \Elementor\Controls_Manager::TEXT,
				'render_type' => 'ui',
				'description' => esc_html__( 'This shortcode will display a list of deselectable tags. The ID is generated by Elementor and only changes if this widget is duplicated, copied, or re-inserted from a template.', 'better-post-filter-widgets-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => \Elementor\Controls_Manager::TEXT,
				'render_type' => 'ui',
				'description' => esc_html__( 'Place this shortcode in the desired mobile location to reposition one or more filter widgets at the selected breakpoint. Supports a single ID or a comma-separated list of IDs. The ID is generated by Elementor and only changes if this widget is duplicated, copied, or re-inserted from a template.', 'better-post-filter-widgets-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'render_type' => 'ui',
				'separator'   => 'before',
				'description' => esc_html__( 'Read-only identifier for this filter widget, generated by Elementor. It only changes if this widget is duplicated, copied, or re-inserted from a template — update any shortcodes that reference it if that happens.', 'better-post-filter-widgets-for-elementor' ),
			]
		);
	...
	protected function render() {
		...
		if ( $settings['filter_list'] ) {
			$index = 0;
			echo '
			<div class="filter-container" data-target-post-widget="' . esc_attr( BPFWE_Helper::bpfwe_get_target_selector( $settings ) ) . '">
